...
public class ContenidoService {
    ...
    public List<ContenidoResponseDTO> obtenerportipo(String tipo){
        return contenidoRepository.findByTipo(tipo.toLowerCase()).stream().map(this::mapToDTO).collect(Collectors.toList());
    }
