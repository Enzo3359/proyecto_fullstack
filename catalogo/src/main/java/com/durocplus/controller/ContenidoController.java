...
public class ContenidoController {
    ...
    @GetMapping("/tipo")
    public ResponseEntity<List<ContenidoResponseDTO>> obtenerPorTipos(
            @RequestParam List<String> tipos) {

        log.info("Buscando contenidos por tipos {}", tipos);

        return ResponseEntity.ok(contenidoService.obtenerportipos(tipos));
    }
