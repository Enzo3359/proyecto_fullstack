...
/**
 * Carga un set base de generos/contenidos "a mano" (hardcodeados).
 * En la practica, Flyway (V3/V4) ya siembra generos antes de que este
 * CommandLineRunner se ejecute, asi que el guard de abajo normalmente lo
 * deja en no-op; se conserva igual como demostracion del patron
 * CommandLineRunner con datos fijos, separado del DataLoader (DataFaker).
 */
@Slf4j
@Component
